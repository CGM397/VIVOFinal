...
public class ApplicationDaoImpl_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "edu.nju.vivofinal.daoimpl.ApplicationDaoImpl"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(ApplicationDaoImpl_ESTest_scaffolding.class.getClassLoader() ,
      ...
      "edu.nju.vivofinal.daoimpl.ApplicationDaoImpl",
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("edu.nju.vivofinal.dao.BaseDao", false, ApplicationDaoImpl_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("org.hibernate.Session", false, ApplicationDaoImpl_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("org.hibernate.Transaction", false, ApplicationDaoImpl_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("org.hibernate.query.Query", false, ApplicationDaoImpl_ESTest_scaffolding.class.getClassLoader()));
  }

  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(ApplicationDaoImpl_ESTest_scaffolding.class.getClassLoader()); 
