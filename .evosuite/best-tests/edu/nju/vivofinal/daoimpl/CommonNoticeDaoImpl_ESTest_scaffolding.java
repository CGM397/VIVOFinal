...
public class CommonNoticeDaoImpl_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "edu.nju.vivofinal.daoimpl.CommonNoticeDaoImpl"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(CommonNoticeDaoImpl_ESTest_scaffolding.class.getClassLoader() ,
      ...
      "edu.nju.vivofinal.daoimpl.CommonNoticeDaoImpl",
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("edu.nju.vivofinal.dao.BaseDao", false, CommonNoticeDaoImpl_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("org.hibernate.Session", false, CommonNoticeDaoImpl_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("org.hibernate.Transaction", false, CommonNoticeDaoImpl_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("org.hibernate.query.Query", false, CommonNoticeDaoImpl_ESTest_scaffolding.class.getClassLoader()));
  }

  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(CommonNoticeDaoImpl_ESTest_scaffolding.class.getClassLoader()); 
