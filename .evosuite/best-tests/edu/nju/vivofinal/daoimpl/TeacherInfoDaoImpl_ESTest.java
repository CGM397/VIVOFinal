...
public class TeacherInfoDaoImpl_ESTest extends TeacherInfoDaoImpl_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      ...
      BaseDao baseDao0 = mock(BaseDao.class, new ViolatedAssumptionAnswer());
      doReturn(vector0).when(baseDao0).findById(any(java.lang.Class.class) , anyLong());
