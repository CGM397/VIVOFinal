...
public class SpecificNoticeDaoImpl_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "edu.nju.vivofinal.daoimpl.SpecificNoticeDaoImpl"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(SpecificNoticeDaoImpl_ESTest_scaffolding.class.getClassLoader() ,
      ...
      "edu.nju.vivofinal.daoimpl.SpecificNoticeDaoImpl",
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("edu.nju.vivofinal.dao.BaseDao", false, SpecificNoticeDaoImpl_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("org.hibernate.Session", false, SpecificNoticeDaoImpl_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("org.hibernate.Transaction", false, SpecificNoticeDaoImpl_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("org.hibernate.query.Query", false, SpecificNoticeDaoImpl_ESTest_scaffolding.class.getClassLoader()));
  }

  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(SpecificNoticeDaoImpl_ESTest_scaffolding.class.getClassLoader()); 
